...
public class Party {
    ...
    public ArrayList<Vorzugskandidaten> getVorzugskandidaten() { return vorzugskandidaten; }
    public void setVorzugskandidaten(ArrayList<Vorzugskandidaten> vorzugskandidaten) { this.vorzugskandidaten = vorzugskandidaten; }
}
